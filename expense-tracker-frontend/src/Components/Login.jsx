...
function Login() {
  ...
  // Clearing errors on every render.
  useEffect(() => {
    dispatch(clearError());
  }, [dispatch]);
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case 'password':
        ...
        else if (value.length < 6) error = 'Password must be at least 8 characters';
        break;
      default:
        break;
    }
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-gray-600">
                ...
                <Link to="/register" className="text-emerald-600 hover:text-emerald-700 font-medium transition-colors underline">
                  Sign up
                </Link>
              </p>
            </div>
