  ...
  const validateField = (name, value, allFormData = formData) => {
    ...
    switch (name) {
      case 'username':
        ...
        else if (!/^[a-zA-Z0-9][a-zA-Z0-9_]+$/.test(value)) error = 'Username can only contain letters, numbers, and underscores';
        break;
      case 'email':
          ...
          <div className="space-y-6">
            ...
            {error && (
              <div className="flex items-start space-x-2 p-4 bg-red-50 border border-red-200 rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-red-600 text-sm mt-1">{error.message || 'Registration failed'}</p>
                </div>
              </div>
            )}
            <button
            ...
            <div className="text-center">
              <p className="text-gray-600">
                ...
                <Link to="/login" className="text-emerald-600 hover:text-emerald-700 font-medium transition-colors underline">
                  Sign in
                </Link>
              </p>
            </div>
